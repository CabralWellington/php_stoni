<%-- 
    ...
    Created on : Mar 15, 2016, 10:03:44 AM
    Author     : Wellington
--%>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Lista de Centro De Custo</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <% CentroDeCusto_Dao aa1 = new CentroDeCusto_Dao();
                                            List<CentroDeCusto> aa2 = new ArrayList<CentroDeCusto>();
                                            aa2 = aa1.Listar();

                                        %>
                                        <tbody>
                                            <%for (CentroDeCusto aa3 : aa2) {%>
                                            <tr>
                                                <td><%=aa3.getNomeCentroDeCusto()%></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-danger" onclick="redirecionar(<%=aa3.getIdCentroDeCusto()%>);" ><i class="fa fa-remove"></i></button>
                                                        <button type="button" class="btn btn-info" onclick="redirecionar2(<%=aa3.getIdCentroDeCusto()%>);" ><i class="fa fa-edit"></i></button>
                                                    </div>
        ...
        <script type="text/javascript">
            function redirecionar(id) {
                if (confirm("Deseja realmente deletar? " + id)) {
                    window.location = "../Cntrl_Del_CentroDeCusto?id=" + id;
                }
            }
        </script>
        <script type="text/javascript">
            function redirecionar2(id) {
            window.location = "AlteraCentroDeCusto.jsp?txtid="+id;
            }
        </script>
    </body>
</html>
