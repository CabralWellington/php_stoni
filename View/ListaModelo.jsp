        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-lg"><b>Sto</b>ni</span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ListUsuario.jsp"><i class="fa fa-list"></i>Listar</a></li>
                                <li><a href="AlteraUsuario.jsp"><i class="fa fa-edit"></i>Alterar</a></li>
                                <li><a href="DeletaUsuario.jsp"><i class="fa fa-remove"></i>Deletar</a></li>
                            </ul>
                        </li>              
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ListCentroDeCusto.jsp"><i class="fa fa-list"></i>Listar</a></li>
                                <li><a href="AlteraCentroDeCusto.jsp"><i class="fa fa-edit"></i>Alterar</a></li>
                                <li><a href="DeletaCentroDeCusto.jsp"><i class="fa fa-remove"></i>Deletar</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ListPerfil.jsp"><i class="fa fa-list"></i>Listar</a></li>
                                <li><a href="AlteraPerfil.jsp"><i class="fa fa-edit"></i>Alterar</a></li>
                                <li><a href="DeletaPerfil.jsp"><i class="fa fa-remove"></i>Deletar</a></li>
                            </ul>
                        </li>
